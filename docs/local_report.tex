...
Detecções & 370 ( 92.5\text{ por cento} ) \\
Ensaios limpos & 347 \\
Latência média & 591 ms \\
Latência mediana & 300 ms \\
Latência desvio-padrão & 743 ms \\
Latência mín--máx & 100 -- 3900 ms \\
\bottomrule
\end{tabular}
\section{Figuras}
...
\includegraphics[width=0.9\linewidth]{trial_subj01_sess01_idx007.png}
\end{center}
\medskip
